...
use sysinfo::{System, Disks}; // Fixed: Removed CpuExt and ProcessExt
    ...
    loop {
        ...
        terminal.draw(|f| {
            let chunks = Layout::default()
                ...
                .margin(1)
                .constraints([
                    Constraint::Length(7), // NEXO-FPS REPORT
                    Constraint::Length(4), // GAUGES
                    Constraint::Length(7), // FPS CHART
            ...
            // Fixed: Table::new now takes constraints as a second argument in newer ratatui
            let table = Table::new(rows, [Constraint::Percentage(70), Constraint::Percentage(30)])
                ...
                .block(Block::default().title(" [ HEAVY APPS ] ").borders(Borders::ALL));
